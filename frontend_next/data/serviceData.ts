    ...
    subs: [
      ...
      },
      {
        ...
        images: [
          ...
          {
            url: "/assets/services-img/flooring/spc/marble.jpg",
      ...
      },
      {
        ...
        images: [
          {
            url: "/assets/services-img/flooring/cleaning/spray.webp",
          ...
          {
            url: "/assets/services-img/flooring/cleaning/cloth.webp",
      ...
      },
      {
        ...
        images: [
          {
            url: "/assets/services-img/flooring/accessories/accessories-Skirting.webp",
            title: 'Skirting',
            description: "Durable skirting designed to protect walls and create a clean, seamless floor finish."
          },
          {
            url: "/assets/services-img/flooring/accessories/accessories-Underlay.avif",
            title: 'Underlay',
            description: "High-quality underlay that enhances stability, reduces noise, and improves overall floor comfort."
          },
          {
            url: "/assets/services-img/flooring/accessories/accessories-Moulding.webp",
            title: 'Moulding',
    ...
    subs: [
      {
        ...
        images: [
          {
            url: "/assets/services-img/booth/exbition-booth/booth-premium.jpeg",
            title: "Premium Booth Setup",
            description: "A high-end booth layout designed to attract attention and enhance brand visibility."
          },
          {
            url: "/assets/services-img/booth/exbition-booth/booth-compact.webp",
          ...
          {
            url: "/assets/services-img/booth/exbition-booth/booth-modern.webp",
    ...
    subs: [
      {
        ...
        images: [
          {
            url: "/assets/services-img/furniture/sofa/modern-sofa.webp",
            title: "Modern Sofa",
            description: "A stylish, comfortable sofa designed for everyday relaxation."
          },
          {
            url: "/assets/services-img/furniture/sofa/luxe-sofa.webp",
            title: "Luxe Sofa",
            description: "Premium sofa craftsmanship for elegant living spaces."
          },
          {
            url: "/assets/services-img/furniture/sofa/comapact-sofa.webp",
            title: "Compact Sofa",
      ...
      },
      {
        ...
        images: [
          {
            url: "/assets/services-img/furniture/tables/dining-table.webp",
            title: "Dining Table",
            description: "A durable dining table designed for everyday use."
          },
          {
            url: "/assets/services-img/furniture/tables/coffee-table.webp",
            title: "Coffee Table",
            description: "A sleek coffee table that blends with any interior."
          },
          {
            url: "/assets/services-img/furniture/tables/side-table.webp",
            title: "Side Table",
      ...
      },
      {
        ...
        images: [
          {
            url: "/assets/services-img/furniture/cabinets/modern-cabinet1.webp",
            title: "Modern Cabinet",
            description: "Stylish storage cabinet that organizes your space."
          },
          {
            url: "/assets/services-img/furniture/cabinets/v-stand.webp",
            title: "TV Stand",
            description: "A clean, modern TV stand with strong build quality."
          },
          {
            url: "/assets/services-img/furniture/cabinets/wall-cabinet.webp",
            title: "Wall Cabinet",
      ...
      },
      {
        ...
        images: [
          {
            url: "/assets/services-img/furniture/chair/dining-chair.webp",
            title: "Dining Chair",
            description: "A comfortable dining chair built for daily use."
          },
          {
            url: "/assets/services-img/furniture/chair/lounge-chair.webp",
            title: "Lounge Chair",
            description: "A relaxing chair with a modern touch."
          },
          {
            url: "/assets/services-img/furniture/chair/office-chaire.webp",
            title: "Office Chair",
      ...
      },
      {
        ...
        images: [
          {
            url: "/assets/services-img/furniture/escape/scape-design.webp",
            title: "Escape Design",
            description: "Unique Escape LTD furniture crafted with detail."
          },
          {
            url: "/assets/services-img/furniture/escape/signature-piece.webp",
            title: "Signature Piece",
            description: "Exclusive design showcasing modern craftsmanship."
          },
          {
            url: "/assets/services-img/furniture/escape/custom-build.webp",
            title: "Custom Build",
    ...
    subs: [
      {
        ...
        images: [
          {
            url: "/assets/services-img/doors/metal/steel-door.webp",
            title: "Steel Door",
          ...
          {
            url: "/assets/services-img/doors/metal/meal-frame.webp",
            title: "Metal Frame",
      ...
      },
      {
        ...
        images: [
          {
            url: "/assets/services-img/doors/wooden/classic-doors.webp",
            title: "Classic Door",
            description: "A timeless wooden door made from quality wood."
          },
          {
            url: "/assets/services-img/doors/wooden/panel-door.webp",
            title: "Panel Door",
            description: "Smooth, elegant door with a natural finish."
          },
          {
            url: "/assets/services-img/doors/wooden/modern-wood-door.webp",
      ...
      },
      {
        ...
        images: [
          {
            url: "/assets/services-img/doors/escape/escape-door.webp",
            title: "Escape Door",
            description: "Premium door design by Escape LTD."
          },
          {
            url: "/assets/services-img/doors/escape/signature-doors.webp",
            title: "Signature Door",
            description: "Exclusive style crafted with precision."
          },
          {
            url: "/assets/services-img/doors/escape/designer-door.webp",
            title: "Designer Door",
    ...
    subs: [
      {
        ...
        images: [
          {
            url: "/assets/services-img/ceiling/gypsum/modern-ceiling.webp",
            title: "Modern Ceiling",
            description: "Smooth gypsum ceiling with clean patterns."
          },
          {
            url: "/assets/services-img/ceiling/gypsum/LED-Ceiling.webp",
            title: "LED Ceiling",
            description: "Gypsum ceiling enhanced with LED lighting."
          },
          {
            url: "/assets/services-img/ceiling/gypsum/Panel-Ceiling.webp",
            title: "Panel Ceiling",
      ...
      },
      {
        ...
        images: [
          {
            url: "/assets/services-img/ceiling/tv-wall/tv-panel.webp",
            title: "TV Panel",
            description: "A clean, decorative wall panel for your TV."
          },
          {
            url: "/assets/services-img/ceiling/tv-wall/Feature-Wall.webp",
            title: "Feature Wall",
            description: "A modern feature wall with sleek finish."
          },
          {
            url: "/assets/services-img/ceiling/tv-wall/Wall-Unit.webp",
            title: "Wall Unit",
    ...
    subs: [
      {
        ...
        images: [
          {
            url: "/assets/services-img/partition/alimuniam/Glass-Partition.webp",
            title: "Glass Partition",
            description: "Modern aluminium-framed partition for offices."
          },
          {
            url: "/assets/services-img/partition/alimuniam/Slim-Partition.webp",
            title: "Slim Partition",
            description: "Minimal, elegant aluminium partition design."
          },
          {
            url: "/assets/services-img/partition/alimuniam/Office-Divider.webp",
      ...
      },
      {
        ...
        images: [
          {
            url: "/assets/services-img/partition/gypsum/Gypsum-Wall.webp",
            title: "Gypsum Wall",
            description: "Smooth gypsum wall with excellent insulation."
          },
          {
            url: "/assets/services-img/partition/gypsum/Room-Divider.webp",
            title: "Room Divider",
            description: "Effective gypsum divider for modern homes."
          },
          {
            url: "/assets/services-img/partition/gypsum/Panel-Partition.webp",
    ...
    subs: [
      {
        ...
        images: [
          {
            url: "/assets/services-img/paint/interior/wall-finish2.webp",
            title: "Wall Finish",
            description: "Smooth, high-quality interior painting."
          },
          {
            url: "/assets/services-img/paint/interior/color-coat2.webp",
            title: "Color Coat",
            description: "Vibrant color application for any room."
          },
          {
            url: "/assets/services-img/paint/interior/matte-finish.webp",
            title: "Matte Finish",
      ...
      },
      {
        ...
        images: [
          {
            url: "/assets/services-img/paint/exterior/WeatherCoat.webp",
            title: "Weather Coat",
            description: "Durable exterior paint for harsh conditions."
          },
          {
            url: "/assets/services-img/paint/exterior/ProtectivePaint.webp",
            title: "Protective Paint",
            description: "Long-lasting outdoor paint with UV resistance."
          },
          {
            url: "/assets/services-img/paint/exterior/ExteriorFinish.jpg",
